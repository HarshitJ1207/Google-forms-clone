...
/* 
    some pointers to update this component
    instead of node: pass the trigger element as children
    item list to be passed as menu
    alignment options as placement
*/